...
if __name__ == "__main__" :
	...
	root = Tk()
	root.configure(background = '#faffbf')
	root.geometry("400x250")
	root.title("Compound Interest Calculator")
	
	label1 = Label(root, text = "Principle Amount(₹) : ", fg = 'black', bg = '#ff03a7')

	label2 = Label(root, text = "Rate(%) : ", fg = 'black', bg = '#ff03a7')
	
	label3 = Label(root, text = "Time(Years) : ", fg = 'black', bg = '#ff03a7')

	label4 = Label(root, text = "Compound Interest : ",	fg = 'black', bg = '#ff03a7')
	...
	button1 = Button(root, text = "Submit", bg = "#bd59ff", fg = "white", command = calculate_ci)
	button2 = Button(root, text = "Clear", bg = "#bd59ff", fg = "white", command = clear_all)
